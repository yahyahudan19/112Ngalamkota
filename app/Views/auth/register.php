...
<html>
  <head>
    ...
    <title>Register - Layanan 112 Kota Malang</title>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="<?= base_url()?>/adminpage/img/favicon.ico">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                  ...
                  </form><small>Already have an account? </small><a href="/auth" class="signup">Login</a>
                </div>
              </div>
            </div>
          </div>
