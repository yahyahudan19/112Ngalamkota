...
<head>
  ...
  <title>Dashboard - Layanan 112 Kota Malang </title>
...
<body>
      ...
      <div class="container-fluid d-flex align-items-center justify-content-between">
        <div class="navbar-header">
          ...
          <a href="/admin" class="navbar-brand">
            ...
            <div class="brand-text brand-sm"><strong class="text-primary">11</strong><strong>2</strong></div>
          </a>
          <!-- Sidebar Toggle Btn-->
        ...
        <div class="right-menu list-inline no-margin-bottom">
          ...
          <div class="list-inline-item dropdown"><a id="navbarDropdownMenuLink1" href="http://example.com" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link messages-toggle"><i class="icon-email"></i><span class="badge dashbg-1">5</span></a>
            <div aria-labelledby="navbarDropdownMenuLink1" class="dropdown-menu messages"><a href="#" class="dropdown-item message d-flex align-items-center">
                <div class="profile"><img src="<?= base_url() ?>/adminpage/img/avatar-3.jpg" alt="..." class="img-fluid">
                ...
                <div class="profile"><img src="<?= base_url() ?>/adminpage/img/avatar-2.jpg" alt="..." class="img-fluid">
                ...
                <div class="profile"><img src="<?= base_url() ?>/adminpage/img/avatar-1.jpg" alt="..." class="img-fluid">
                ...
                <div class="profile"><img src="<?= base_url() ?>/adminpage/img/avatar-5.jpg" alt="..." class="img-fluid">
          ...
          <div class="list-inline-item logout">
            <a id="logout" href="/auth" class="nav-link">Logout <i class="icon-logout"></i></a>
          </div>
        </div>
      </div>
    </nav>
  ...
  <script src="<?= base_url() ?>/adminpage/js/charts-custom.js"></script>
  <script src="<?= base_url() ?>/adminpage/js/charts-home.js"></script>
