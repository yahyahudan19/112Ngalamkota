             ...
             <form class="form-horizontal row" action="/report/edit/" method="post" enctype="multipart/form-data">
               ...
               <div class="form-group row">
                 ...
                 <div class="form-group col-lg-6">
                   ...
                   <select name="petugas" class="form-control" id="petugas">
                     ...
                     <?php
                      ...
                      ?>
                       <option value="<?= $data['nama_petugas'] ?>" <?php if ($data['nama_petugas'] == $reportdata[0]['nama_petugas']) { ?> selected <?php } ?>><?= $data['nama_petugas'] ?></option>
                     <?php
                      }
                      ?>
                   </select>
                 ...
                 <?php
                  ...
                  ?>
                   <img src="<?= base_url() ?>/uploads/<?= $row['gambar'] ?>" height="300" width="500" class="ml-3 mb-4" />
                 <?php
                  }
                  ?>
